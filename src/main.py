...
from src.ml import check_ml
from src.utilities import get_data
...
def main():
    ...
    check_ml(data, n_run, knn, n_fold, n_proportion, n_subset, model_type, prediction_type, features,
             recalculate_similarity, disjoint_cv, split_both, output_file, model_fun=None, n_seed=n_seed)
    return
